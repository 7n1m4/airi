...
const selectedRerankerProvider = defineModel<RerankerProviderId>('selectedRerankerProvider', { default: 'laya' })
          ...
          >
            ...
            <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
              ...
              <button
                ...
                @click="selectedRerankerProvider = 'laya'"
              >
                ...
                <p class="text-[10px] text-neutral-500 leading-snug dark:text-neutral-400">
                  High-speed on-device ONNX model running locally via WebGPU/WASM.
                </p>
                <div class="mt-auto w-full border-t border-neutral-100 pt-2 dark:border-neutral-800">
                  <span class="inline-flex items-center gap-1 rounded bg-neutral-100 px-2 py-1 text-[10px] text-neutral-700 font-medium dark:bg-neutral-800 dark:text-neutral-200">
              ...
              <button
                ...
                :class="[
                  'flex flex-col items-start gap-2 rounded-xl border p-3.5 text-left transition-all duration-150',
                  selectedRerankerProvider === 'typesafe_jev'
                    ? 'border-primary-500 bg-primary-50/40 text-primary-900 shadow-sm dark:bg-primary-950/30 dark:text-primary-200'
                    : 'border-neutral-200 bg-white hover:border-neutral-300 text-neutral-700 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-300',
                ]"
                @click="selectedRerankerProvider = 'typesafe_jev'"
              >
                <div class="w-full flex items-center justify-between">
                  <div class="flex items-center gap-1.5 text-xs font-semibold">
              ...
              <button
                ...
                :class="[
                  'flex flex-col items-start gap-2 rounded-xl border p-3.5 text-left transition-all duration-150',
                  selectedRerankerProvider === 'openrouter'
                    ? 'border-primary-500 bg-primary-50/40 text-primary-900 shadow-sm dark:bg-primary-950/30 dark:text-primary-200'
                    : 'border-neutral-200 bg-white hover:border-neutral-300 text-neutral-700 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-300',
                ]"
                @click="selectedRerankerProvider = 'openrouter'"
              >
                <div class="w-full flex items-center justify-between">
                  <div class="flex items-center gap-1.5 text-xs font-semibold">
