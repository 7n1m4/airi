...
export const SETTINGS_CATALOG_ITEMS: CatalogNodeItem[] = [
  ...
  {
    id: 'mod-system-one',
    label: 'System 1 Coprocessor',
    shortLabel: 'System 1',
    titleKey: 'settings.pages.modules.system-one.title',
    descriptionKey: 'settings.pages.modules.system-one.description',
    description: 'High-speed cognitive coprocessor for zero-shot query triage, batched candidate reranking, and affective heuristics',
    glyph: '速',
    clusterGroup: 'PERCEPTION & FACULTIES 感',
    route: '/settings/modules/system-one',
